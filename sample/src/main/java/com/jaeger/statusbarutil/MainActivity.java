...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnMyImage = findViewById(R.id.btn_switch_my);
        ...
        mBtnMyImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, MyImageActivity.class);
                startActivity(intent);
            }
        });
